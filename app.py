...
QUESTIONS = [
    ...
    {"id": 2, "text": "We sell fragile wine bottles and loose eggs", "target": 100, "ans_text": "CHALLENGING (Fragile)", "exp": "Challenging. Requires complex, expensive grippers and products can break because of fragility."},
    {"id": 3, "text": "Annual seasonality is very low (Even throughput all year long)", "target": 0, "ans_text": "IDEAL (Steady)", "exp": "Good! Automation hates idle time."},
    ...
    {"id": 7, "text": "Single dispatch type: Parcels only", "target": 0, "ans_text": "IDEAL (Parcel Only)", "exp": "Good! Simple logic for sorting."},
    {"id": 8, "text": "High Value Added Services (Gift wrap, ironing, customized packaging)", "target": 100, "ans_text": "CHALLENGING (VAS)", "exp": "Challenging. Humans are better at custom tasks."},
    ...
    {"id": 14, "text": "Multiple dispatch avenues (Parcel + Pallet + cartons)", "target": 100, "ans_text": "CHALLENGING (Mixed Channel)", "exp": "Challenging. Requires mixed workflows."},
    ...
    {"id": 25, "text": "High Volumes, Low Variation in seasonality", "target": 0, "ans_text": "IDEAL (The Dream)", "exp": "Good! The perfect scenario for automation."}
]
...
def start_question(data):
    ...
    # 2. SERVER AUTOMATION: Wait 12s (12s timer + 2s buffer)
    eventlet.sleep(14) 
